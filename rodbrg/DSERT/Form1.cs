    ...
    public partial class Form1 : Form
    {
        ...
        private void fSpawn(int nRow)
        {
            ...
            for (int i = 1; i <= 8; i++)
            {
                ...
                if (nType == 6)
                {
                    sText = sText + Convert.ToString(i);
                }
            }
            ...
            nPos = rnd1.Next(1, sText.Length + 1);
            nCol = Convert.ToInt32(sText.Substring(nPos - 1, 1));
        ...
        private void fReset()
        {
            ...
            for (int i = 8; i >= 2;i--)
            {
                ...
                for (int j = 1; j <= 8; j++)
                {
                    ...
                    {
                        nCount += 1;
                        nPos = (nCol - 1) * 8 + nRow-1;
                        nNumber = rnd1.Next(4, 7);
        ...
        private void fPeek(int nValue, int nRotate, ref PictureBox _pic2)
        {
            ...
            {
                Name = "pictureBox1",
                Image = Image.FromFile(@"F desert.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture2 = new PictureBox
            {
                Name = "pictureBox2",
                Image = Image.FromFile(@"F deserthill.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture3 = new PictureBox
            {
                Name = "pictureBox3",
                Image = Image.FromFile(@"F plumbing.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture4 = new PictureBox
            {
                Name = "pictureBox4",
                Image = Image.FromFile(@"F roadtype1.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture5 = new PictureBox
            {
                Name = "pictureBox5",
                Image = Image.FromFile(@"F roadtype2.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
            PictureBox picture6 = new PictureBox
            {
                Name = "pictureBox6",
                Image = Image.FromFile(@"F roadtype3.png"),
                SizeMode = PictureBoxSizeMode.StretchImage
            };
